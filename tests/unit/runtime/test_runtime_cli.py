...
def test_build_parser_has_show_compatibility_flag():
    """Test that the parser has a "--show-compatibility" flag."""
    parser = cli.build_parser()
    args = parser.parse_args(["--show-compatibility"])
    assert args.show_compatibility is True

    args = parser.parse_args(["-c"])
    assert args.show_compatibility is True

    args = parser.parse_args([])
    assert args.show_compatibility is False
